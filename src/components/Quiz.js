        ...
        <div className="row vh-100 align-items-center justify-content-center">
          <div className="col-lg-8">
            ...
            >
              ...
              {/* Display Skip Count */}
              <div className="mt-3">Skip Count: {skipCount}</div>
              ...
              {questionIndex + 1 !== quizs.length ? (
                <div className="button-container">
                  ...
                  <button
                    className="btn py-2 w-100 mt-3 bg-warning text-light fw-bold flex"
                ...
                <button
                  className="btn py-2 w-100 mt-3 bg-primary text-light fw-bold flex"
